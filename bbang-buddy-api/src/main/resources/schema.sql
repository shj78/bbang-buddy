...
DROP TABLE IF EXISTS BBANGPOT_PARTICIPANT;

DROP TABLE IF EXISTS BBANGPOT;

DROP TABLE IF EXISTS BBD_USER_LOGIN;
...
DROP SEQUENCE IF EXISTS BBD_USER_LOGIN_SEQ;
...
CREATE SEQUENCE BBD_USER_LOGIN_SEQ;
...
CREATE TABLE BBD_USER_LOGIN (
                                ID NUMBER PRIMARY KEY,
                                BBD_USER_ID NUMBER NOT NULL,
                                LOGIN_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                                IP_ADDRESS VARCHAR2(45),
                                CONSTRAINT FK_BBDUSERLOGIN_BBDUSER FOREIGN KEY (BBD_USER_ID) REFERENCES BBD_USER(ID) ON DELETE CASCADE
);
    
create table BBANGPOT_PARTICIPANT
(
    BBANGPOT_ID NUMBER(19)         not null,
    BBD_USER_ID VARCHAR2(255) not null,
